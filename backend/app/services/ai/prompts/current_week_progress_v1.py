...
most recently completed one. Same JSON schema as v3 (headline/summary/
...
VERSION = "current_week_progress.v1"
...
SYSTEM_PROMPT = (
    ...
    "viktorina, Bellashuv, kurs progressi) va bitta 'e'tibor qaratish kerak "
    "bo'lgan xususiyat' (feature_spotlight_hint) JSON ko'rinishida beriladi.\n\n"
    ...
    "ohangda, hech qachon qat'iy bashorat sifatida emas (\"shu sur'atda "
    "davom etsangiz, taxminan...\" kabi).\n"
...
def build_user_prompt(stats: dict, spotlight_hint: dict) -> str:
    ...
    return f"Hozirgi (davom etayotgan) hafta statistikasi va e'tibor qaratish kerak bo'lgan xususiyat:\n{json.dumps(payload, ensure_ascii=False)}"
